...
def recency_scores(blocks: list[ContextBlock]) -> list[float | None]:
...
def token_efficiency_scores(blocks: list[ContextBlock]) -> list[float | None]:
...
def source_priority_scores(
    blocks: list[ContextBlock], priorities: dict[str, float]
) -> list[float | None]:
