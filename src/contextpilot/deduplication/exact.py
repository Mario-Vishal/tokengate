...
from contextpilot.utils.hashing import hash_content


def _effective_score(block: ContextBlock) -> float:
...
def _preferred(existing: ContextBlock, candidate: ContextBlock) -> ContextBlock:
