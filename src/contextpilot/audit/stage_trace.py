...
from contextpilot.core.result import StageRecord
...
class StageTracer:
    ...
    def _tokens(self, blocks: Sequence[ContextBlock]) -> int:
    ...
    def add(
        ...
        stage: str,
        *,
        before: Sequence[ContextBlock],
        after: Sequence[ContextBlock],
        t0: float,
